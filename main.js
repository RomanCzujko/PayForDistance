...
<div id="modal-overlay-btn" class="modal-overlay" >
  <div class="modal-window" id="modal-window-send">
    ...
    <div><i class="fas fa-check-circle"></i></div>
      <span class="modal-title" id="title">Please check your booking details! Push to Accept or Back to editing your booking.</span>
    </div>
...
$(crosbr = function() {
    // add input listeners
    google.maps.event.addDomListener(window, 'keyup', function () {
        var from_places = new google.maps.places.Autocomplete(document.getElementById('from_places'));
        var to_places = new google.maps.places.Autocomplete(document.getElementById('to_places'));
